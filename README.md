...
[mongodb-memory-server](https://github.com/nodkz/mongodb-memory-server) - Allows you to run Mongoose in-memory instead of connecting to a persistent database.
